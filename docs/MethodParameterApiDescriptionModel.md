...
**typeAsString** | **string** |  | [optional] [default to undefined]
...
```typescript
import { MethodParameterApiDescriptionModel } from 'puupee-api';

const instance: MethodParameterApiDescriptionModel = {
    name,
    typeAsString,
    type,
    typeSimple,
